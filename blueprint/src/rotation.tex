\chapter{Une preuve : Nombre de rotation}
...
% \newenvironment{theorem}{\begin{box_thm}\begin{theoreme}}{\end{theoreme}\end{box_thm}}


% \newtcolorbox{box_defi}{colback=white!100,colframe=black!100,enhanced}
% \newenvironment{definition}{\begin{box_defi}\begin{definition}}{\end{definition}\end{box_defi}}
...
% \newenvironment{corollary}{\begin{box_coro}\begin{corollaire}}{\end{corollaire}\end{box_coro}}

% \newtcolorbox{box_ppt}{colback=white!100,colframe=black!100,enhanced}
% \newenvironment{proposition}{\begin{box_ppt}\begin{propriete}}{\end{propriete}\end{box_ppt}}

% \newtcolorbox{box_lm}{colback=white!100,colframe=black!100,enhanced}
% \newenvironment{lemma}{\begin{box_lm}\begin{lemme}}{\end{lemme}\end{box_lm}}
...
\begin{theorem}\label{passage au quotient}
...
\begin{lemma}\label{préli relèvement}
...
\begin{corollary}\label{isom relation d'équiv sur les homéo}\textbf{Isomorphisme entre $\EnsembleQuotient{\mathcal{E}^+}{\Tent}$ et $\HomT$}\\
...
\begin{theorem}\label{rho commute}
...
\section{Continuité du nombre de rotation par rapport à $T$}
